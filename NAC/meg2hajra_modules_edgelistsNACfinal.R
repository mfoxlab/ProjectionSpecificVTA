...
path_to_files <- "C://Users/hsohail/Documents/WGCNA/NAC" ## this is my current path but it may change for you
file_prefix <- "9TOM.NAC" ## change this to the name of your TOM file
files <- list.files( path = path_to_files, pattern = paste0(file_prefix, "-block.*\\.RData$"), full.names = TRUE )

load(file= "C://Users/hsohail/Documents/WGCNA/NAC/netNAC_9.Rdata")


# FILE EDITING ------------------------------------------------------------
gene_names<-names(netNAC_9$colors)
...
write.csv(combined_edges, "C://Users/hsohail/Documents/WGCNA/NAC/NAC_edges.csv", row.names = FALSE)



## meg to hajra-- you can load your previous workspace, but please start here to make sure that the variables become correct 
module_assignments <- netNAC_9$colors
...
save.image(file = "C://Users/hsohail/Documents/WGCNA/NAC/NACEdgesWorkspace.RData")
